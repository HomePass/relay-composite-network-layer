...
var mergeSchemas = exports.mergeSchemas = function mergeSchemas(schemaMap, options) {
  ...
  var _Object$keys$reduce = Object.keys(schemaMap).reduce(function (_ref, key) {
    var schema = _ref.schema,
        extensions = _ref.extensions;

    var source = jsonToSchema(key, schemaMap[key]);
    return Object.keys(source.types).reduce(function (_ref2, typeName) {
      var schema = _ref2.schema,
          extensions = _ref2.extensions;

      var _mergeType = mergeType(schema, source, typeName),
          type = _mergeType.type,
          typeExtensions = _mergeType.extensions;
      ...
      schema = _Object$keys$reduce.schema,
      extensions = _Object$keys$reduce.extensions;

  return {
    schema: {
      data: {
        __schema: _extends({}, (0, _utils.into)({}, (0, _utils.pairs)(_utils.pick.apply(undefined, [schema].concat(ROOT_TYPES))).map(function (_ref3) {
...
var OPTION_KEYS = ['queryType', 'mutationType', 'subscriptionType'];
